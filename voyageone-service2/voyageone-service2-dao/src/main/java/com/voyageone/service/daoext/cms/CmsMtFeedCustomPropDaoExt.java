 ...
 */
@Repository
public class CmsMtFeedCustomPropDaoExt extends ServiceBaseDao {

    // 根据类目路径查询自定义属性信息(包含共通属性)
    public List<CmsMtFeedCustomPropModel> selectWithCategory(Map<String, Object> params) {
        return selectList("cms_mt_feed_custom_prop_selectWithCatPath", params);
    }

    // 根据类目路径查询属性信息
    public List<Map<String, Object>> selectAllAttr(Map<String, Object> params) {
        return selectList("cms_mt_feed_custom_prop_selectAllAttr", params);
    }

    // 根据类目路径查询已翻译的属性信息
    // 只查询feed_prop_original和feed_prop_translation
    public List<Map<String, Object>> selectAttrs(Map<String, Object> params) {
        return selectList("cms_mt_feed_custom_prop_selectAttrByTrans", params);
    }

    // 根据类目路径查询自定义已翻译属性信息(不包含共通属性)
    public List<Map<String, Object>> selectTransProp(Map<String, Object> params) {
        return selectList("cms_mt_feed_custom_prop_selectWithCat2", params);
    }

    // 根据类目路径查询自定义未翻译属性信息(不包含共通属性)
    public List<Map<String, Object>> selectOrigProp(Map<String, Object> params) {
        return selectList("cms_mt_feed_custom_prop_selectWithCat1", params);
    }

    // 查询指定类目属性是否存在
    public boolean isAttrExist(Map<String, Object> params) {
        List<Map<String, Object>> rslt = selectList("cms_mt_feed_custom_prop_isexist", params);
    ...
    public int insertAttr(Map<String, Object> params) {
        return insert("cms_mt_feed_custom_prop_add", params);
    }

    // 根据类目路径查询自定义未翻译属性信息(不包含共通属性)
    public int updateAttr(Map<String, Object> params) {
        return update("cms_mt_feed_custom_prop_update", params);
    }

    // 查询指定属性值是否存在
    public boolean isPropValueExist(Map<String, Object> params) {
        List<Map<String, Object>> rslt = selectList("cms_mt_feed_custom_option_isexist", params);
        if (rslt != null && rslt.size() > 0) {
            return true;
        }
        return false;
    ...
    public boolean isPropValueExistById(Map<String, Object> params) {
        List<Map<String, Object>> rslt = selectList("cms_mt_feed_custom_option_isexistbyid", params);
        if (rslt != null && rslt.size() > 0) {
            return true;
        }
        return false;
    ...
    public int insertPropValue(Map<String, Object> params) {
        return insert("cms_mt_feed_custom_option_add", params);
    }

    // 添加属性值
    public int updatePropValue(Map<String, Object> params) {
        return update("cms_mt_feed_custom_option_update", params);
    }

    // 查询属性值
    public List<Map<String, Object>> selectPropValue(Map<String, Object> params) {
        return selectList("cms_mt_feed_custom_option_selectById", params);
    }
}
