...
public enum EnumJMProductImportColumn2 {
    ...
    private EnumJMProductImportColumn2(String columnName, String tableName, String text) {
        
        this.excelColumn = new ExcelColumn(columnName, EnumCount.ProductColumnIndex++, tableName, text);
    }
    private EnumJMProductImportColumn2(String columnName, String tableName, String text, EnumExcelColumnType columnType, boolean isNull)
    {
        this.excelColumn = new ExcelColumn(columnName, EnumCount.ProductColumnIndex++, tableName, text,columnType,isNull);
    }

    public  static  List<EnumJMProductImportColumn2> getList()
    {
        List<EnumJMProductImportColumn2> listEnumJMProductImportColumn = Arrays.asList(EnumJMProductImportColumn2.values());
    ...
    public static  List<ExcelColumn> getListExcelColumn() {
        ...
        EnumJMProductImportColumn2[] array = EnumJMProductImportColumn2.values();
        for (EnumJMProductImportColumn2 column : array) {
