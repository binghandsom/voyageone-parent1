...
public enum EnumPlatformInfoSum implements IEnumDataAmountSum {
    ...
    CMS_PLATFORM_quantity_not_OnSale("CMS_PLATFORM_platform_not_OnSale","{lock:'0',\"common.fields.quantity\":{ $gt:0},\"platforms.P%s.pStatus\":'OnSale',\"platforms.P%s.pReallyStatus\":'InStock'}","", "", "下架有库存商品数", (m) -> {
        return String.format(m.getQueryStr(), m.getCartId(), m.getCartId());
    });
