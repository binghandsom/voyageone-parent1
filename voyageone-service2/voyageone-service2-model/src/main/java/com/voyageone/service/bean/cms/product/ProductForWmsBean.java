 ...
 */
public class ProductForWmsBean {
    ...
    private String materialFabricName = "";
    ...
    private String hsCodePuId = "";

    private String hsCodePu = "";

    private String unitPu = "";

    private String hsDescriptionPu = "";
    ...
    public String getMaterialFabricName() {
        return materialFabricName;
    }

    public void setMaterialFabricName(String materialFabricName) {
        this.materialFabricName = materialFabricName;
    }
    ...
    public String getHsCodePuId() {
        return hsCodePuId;
    }

    public void setHsCodePuId(String hsCodePuId) {
        this.hsCodePuId = hsCodePuId;
    }

    public String getHsCodePu() {
        return hsCodePu;
    }

    public void setHsCodePu(String hsCodePu) {
        this.hsCodePu = hsCodePu;
    }

    public String getUnitPu() {
        return unitPu;
    }

    public void setUnitPu(String unitPu) {
        this.unitPu = unitPu;
    }

    public String getHsDescriptionPu() {
        return hsDescriptionPu;
    }

    public void setHsDescriptionPu(String hsDescriptionPu) {
        this.hsDescriptionPu = hsDescriptionPu;
    }
