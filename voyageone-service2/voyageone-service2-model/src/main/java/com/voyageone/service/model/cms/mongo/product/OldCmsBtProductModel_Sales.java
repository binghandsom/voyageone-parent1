 ...
 * @since 2.0.0
 */
public class OldCmsBtProductModel_Sales extends BaseMongoMap<String, Object> {
    ...
    public OldCmsBtProductModel_Sales() {
    }

    public OldCmsBtProductModel_Sales(Map<String, Object> map) {
        this.putAll(map);
    }
