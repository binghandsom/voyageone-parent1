...
public class SDKServiceLocator extends org.apache.axis.client.Service implements com.voyageone.common.components.yimei.eucp.SDKService {
...
//    	 private String SDKService_address = props.readValue("SMS_URL");
    private String SDKService_address =  Codes.getCodeName(Constants.smsInfo.SMS_INFO, Constants.smsInfo.URL);
    ...
    public com.voyageone.common.components.yimei.eucp.SDKClient getSDKService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.voyageone.common.components.yimei.eucp.SDKServiceBindingStub _stub = new com.voyageone.common.components.yimei.eucp.SDKServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.voyageone.common.components.yimei.eucp.SDKClient.class.isAssignableFrom(serviceEndpointInterface)) {
                com.voyageone.common.components.yimei.eucp.SDKServiceBindingStub _stub = new com.voyageone.common.components.yimei.eucp.SDKServiceBindingStub(new java.net.URL(SDKService_address), this);
                _stub.setPortName(getSDKServiceWSDDServiceName());
                return _stub;
            }
        }
