 ...
 * @version 2.0.0
 */
public class JmDealInfoBean extends JmBaseBean {
    ...
    private Integer user_purchase_limit;

    private Integer shipping_system_id;

    private String product_long_name;

    private String product_medium_name;

    private String product_short_name;

    private String address_of_produce;
    ...
    private String search_meta_text_custom;

    private String description_properties;

    private String description_usage;
    ...
    public String getPartner_sku_nos() {
        return partner_sku_nos;
    }
