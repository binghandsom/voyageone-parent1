...
public class ModelProductCNBean extends BaseBean{
	...
	private Boolean cnIsPrimaryProduct;
	...
	public void setCnOfficialPrePublishDateTime(String cnOfficialPrePublishDateTime) {
		this.cnOfficialPrePublishDateTime = cnOfficialPrePublishDateTime;
	}
	...
	public void setTbPrePublishDateTime(String tbPrePublishDateTime) {
		this.tbPrePublishDateTime = tbPrePublishDateTime;
	}
	...
	public void setTmPrePublishDateTime(String tmPrePublishDateTime) {
		this.tmPrePublishDateTime = tmPrePublishDateTime;
	}
	...
	public void setTgPrePublishDateTime(String tgPrePublishDateTime) {
		this.tgPrePublishDateTime = tgPrePublishDateTime;
	}
	...
	public void setJdPrePublishDateTime(String jdPrePublishDateTime) {
		this.jdPrePublishDateTime = jdPrePublishDateTime;
	}
	...
	public void setJgPrePublishDateTime(String jgPrePublishDateTime) {
		this.jgPrePublishDateTime = jgPrePublishDateTime;
	}
	...
	/**
	 * @return the cnIsPrimaryProduct
	 */
	public Boolean getCnIsPrimaryProduct() {
		return cnIsPrimaryProduct;
	}

	/**
	 * @param cnIsPrimaryProduct the cnIsPrimaryProduct to set
	 */
	public void setCnIsPrimaryProduct(Boolean cnIsPrimaryProduct) {
		this.cnIsPrimaryProduct = cnIsPrimaryProduct;
	}
