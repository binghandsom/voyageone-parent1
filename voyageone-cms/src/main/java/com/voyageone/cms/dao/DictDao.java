...
public class DictDao extends BaseDao {
    ...
    public List<DictWordBean> selectAll(String channel_id, int start, int length) {
        return selectList("ims_mt_dict_selectAll", parameters("channel_id", channel_id, "start", start, "length", length));
    }

    public int selectAllCount(String channel_id) {
        return selectOne("ims_mt_dict_selectAllCount", parameters("channel_id", channel_id));
    }

    public int insertDict(DictWordBean dictWordBean) {
        return insert("ims_mt_dict_insertDict", dictWordBean);
    }

    public int updateDict(DictWordBean dictWordBean) {
        return update("ims_mt_dict_updateDict", dictWordBean);
    }

    public int deleteDict(DictWordBean dictWordBean) {
        return delete("ims_mt_dict_deleteDict", dictWordBean);
    }

    public List<DictWordBean> selectByName(DictWordBean dictWordBean) {
        return selectList("ims_mt_dict_selectByName", dictWordBean);
    }

    public List<DictWordBean> selectSimpleDict(String channel_id) {
        return selectList("ims_mt_dict_selectSimpleDict", parameters("channel_id", channel_id));
    }
}
