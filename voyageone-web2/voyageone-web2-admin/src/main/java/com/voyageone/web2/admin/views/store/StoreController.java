...
public class StoreController extends AdminController {
	...
	public AjaxResponse searchStoreByPage(@RequestBody StoreFormBean form) {
		...
		// 检索仓库信息
		PaginationResultBean<WmsMtStoreBean> storePage = storeService.searchStoreByPage(form.getOrderChannelId(), form.getStoreName(),
	...
	public AjaxResponse searchStoreConfigByPage(@RequestBody CommonConfigFormBean form) {
		...
		Preconditions.checkNotNull(form.getPageSize());
		// 检索仓库配置信息
		PaginationResultBean<CtStoreConfigBean> storeConfigPage = storeService.searchStoreConfigByPage(form.getStoreId(),
