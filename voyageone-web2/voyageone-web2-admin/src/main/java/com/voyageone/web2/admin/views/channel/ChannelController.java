...
public class ChannelController extends AdminController {
	...
	public AjaxResponse searchChannelByPage(@RequestBody ChannelFormBean form) {
		...
		// 检索渠道信息
		PaginationResultBean<TmOrderChannelBean> channelPage = channelService.searchChannelByPage(form.getOrderChannelId(),
	...
	public AjaxResponse searchChannelConfigByPage(@RequestBody CommonConfigFormBean form) {
		...
		Preconditions.checkNotNull(form.getPageSize());
		// 检索渠道配置信息
		PaginationResultBean<TmOrderChannelConfigBean> channelConfigPage = channelService.searchChannelConfigByPage(
