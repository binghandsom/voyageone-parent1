...
public class TaskController extends AdminController {
	...
	public AjaxResponse searchTaskByPage(@RequestBody TaskFormBean form) {
		...
		// 检索任务信息
		PaginationResultBean<ComMtTaskBean> taskPage = taskService.searchTaskByPage(form.getTaskType(), form.getTaskName(),
	...
	public AjaxResponse searchTaskConfigByPage(@RequestBody CommonConfigFormBean form) {
		...
		Preconditions.checkNotNull(form.getPageSize());
		// 检索任务配置信息
		PaginationResultBean<TmTaskControlBean> taskConfigPage = taskService.searchTaskConfigByPage(form.getTaskId(),
