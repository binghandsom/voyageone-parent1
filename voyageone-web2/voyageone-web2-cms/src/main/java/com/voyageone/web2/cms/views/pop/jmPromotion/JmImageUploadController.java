...
public class JmImageUploadController extends CmsController {
    ...
    public AjaxResponse upload(HttpServletRequest request, @RequestParam Long promotionId, @RequestParam String imageType) throws Exception {
    ...
    public AjaxResponse batUpload(HttpServletRequest request) throws Exception {
        ...
        InputStream input = file.getInputStream();
        Map<String, Object> response = jmImageUploadService.batchUploadImage(file, imageName, getUser());
