...
public class CmsBtJmApiLogTest {
    ...
    public void testGet() {
        ...
        CmsBtJmApiLogModel CmsBtJmApiLog = service.get(1);
    }
    ...
    public void testGetList() {
        //ApplicationContext context = new ClassPathXmlApplicationContext("spring-test.xml");
        //CmsBtJmApiLogService service = (CmsBtJmApiLogService)context.getBean("CmsBtJmApiLogService");
        List<CmsBtJmApiLogModel> list = service.getList();
    }
    ...
    public void testUpdate() {
        ...
        CmsBtJmApiLogModel CmsBtJmApiLogNew = service.get(1);
    }
    ...
    public void testCreate() {
        ...
        CmsBtJmApiLogModel CmsBtJmApiLogNew = service.get(3);
    }
