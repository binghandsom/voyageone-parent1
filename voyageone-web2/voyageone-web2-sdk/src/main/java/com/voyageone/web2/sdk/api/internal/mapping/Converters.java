package com.voyageone.web2.sdk.api.internal.mapping;
	...
	public static <T> T convert(Class<T> clazz, Reader reader) throws ApiException {
		...
		try {
			...
			for (PropertyDescriptor pd : pds) {
				...
				Field field;
				if (baseFields.contains(itemName) && VoApiResponse.class.isAssignableFrom(clazz)) {
					field = getField(VoApiResponse.class, pd);
				} else {
