...
/**
 *  AssociativeEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AssociativeEntity implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":associativeEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "associativeEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AssociativeEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AssociativeEntity object = new AssociativeEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"associativeEntity".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AssociativeEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
