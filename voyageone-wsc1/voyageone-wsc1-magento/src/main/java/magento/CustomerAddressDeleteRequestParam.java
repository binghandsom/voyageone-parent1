/**
 * CustomerAddressDeleteRequestParam.java
 *
...
/**
 *  CustomerAddressDeleteRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerAddressDeleteRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "customerAddressDeleteRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":customerAddressDeleteRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "customerAddressDeleteRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CustomerAddressDeleteRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerAddressDeleteRequestParam object = new CustomerAddressDeleteRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerAddressDeleteRequestParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CustomerAddressDeleteRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
