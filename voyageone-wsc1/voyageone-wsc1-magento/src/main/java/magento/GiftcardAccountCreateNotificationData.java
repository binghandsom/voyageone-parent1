...
/**
 *  GiftcardAccountCreateNotificationData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GiftcardAccountCreateNotificationData implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = giftcardAccountCreateNotificationData
     ...
     */
    protected boolean localRecipient_storeTracker = false;
    ...
    public boolean isRecipient_storeSpecified() {
        return localRecipient_storeTracker;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":giftcardAccountCreateNotificationData",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "giftcardAccountCreateNotificationData", xmlWriter);
            }
        }

        namespace = "";
        writeStartElement(null, namespace, "recipient_name", xmlWriter);

        if (localRecipient_name == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "recipient_name cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localRecipient_name);
        }

        xmlWriter.writeEndElement();

        namespace = "";
        writeStartElement(null, namespace, "recipient_email", xmlWriter);

        if (localRecipient_email == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "recipient_email cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localRecipient_email);
        }

        xmlWriter.writeEndElement();

        if (localRecipient_storeTracker) {
            namespace = "";
            writeStartElement(null, namespace, "recipient_store", xmlWriter);

            if (localRecipient_store == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "recipient_store cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localRecipient_store);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "recipient_name"));
        ...
        elementList.add(new javax.xml.namespace.QName("", "recipient_email"));

        if (localRecipient_email != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localRecipient_email));
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "recipient_email cannot be null!!");
        }
        ...
        if (localRecipient_storeTracker) {
            elementList.add(new javax.xml.namespace.QName("", "recipient_store"));

            if (localRecipient_store != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localRecipient_store));
            } else {
                throw new org.apache.axis2.databinding.ADBException(
                    "recipient_store cannot be null!!");
            }
        ...
        public static GiftcardAccountCreateNotificationData parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "recipient_name").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "recipient_email").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "recipient_store").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
