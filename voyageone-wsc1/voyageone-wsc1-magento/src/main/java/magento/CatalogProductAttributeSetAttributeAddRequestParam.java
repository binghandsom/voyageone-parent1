...
/**
 *  CatalogProductAttributeSetAttributeAddRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductAttributeSetAttributeAddRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductAttributeSetAttributeAddRequestParam", "ns1");
     ...
     */
    protected boolean localAttributeGroupIdTracker = false;
    ...
    public boolean isAttributeGroupIdSpecified() {
        return localAttributeGroupIdTracker;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localAttributeGroupIdTracker) {
            namespace = "";
            writeStartElement(null, namespace, "attributeGroupId", xmlWriter);

            if (localAttributeGroupId == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "attributeGroupId cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localAttributeGroupId);
            }
        ...
        if (localSortOrderTracker) {
            namespace = "";
            writeStartElement(null, namespace, "sortOrder", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "attributeId"));
        ...
        if (localAttributeGroupIdTracker) {
            elementList.add(new javax.xml.namespace.QName("", "attributeGroupId"));
        ...
        if (localSortOrderTracker) {
            elementList.add(new javax.xml.namespace.QName("", "sortOrder"));
    ...
    public static class Factory {
        ...
        public static CatalogProductAttributeSetAttributeAddRequestParam parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "attributeId").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "attributeGroupId").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "sortOrder").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
