...
/**
 *  CatalogCategoryTree bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryTree implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogCategoryTree", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryTree", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogCategoryTree parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogCategoryTree object = new CatalogCategoryTree();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogCategoryTree".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogCategoryTree) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
