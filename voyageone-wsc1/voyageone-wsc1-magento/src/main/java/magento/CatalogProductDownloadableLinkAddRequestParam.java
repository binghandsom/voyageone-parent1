...
/**
 *  CatalogProductDownloadableLinkAddRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductDownloadableLinkAddRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductDownloadableLinkAddRequestParam", "ns1");
     ...
     * field for Resource
     */
    protected magento.CatalogProductDownloadableLinkAddEntity localResource;
    ...
    /**
     * Auto generated getter method
     * @return magento.CatalogProductDownloadableLinkAddEntity
     */
    public magento.CatalogProductDownloadableLinkAddEntity getResource() {
    ...
    public void setResource(
        magento.CatalogProductDownloadableLinkAddEntity param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductDownloadableLinkAddRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductDownloadableLinkAddRequestParam", xmlWriter);
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "resource").equals(
                            reader.getName())) {
                    object.setResource(magento.CatalogProductDownloadableLinkAddEntity.Factory.parse(
                            reader));
