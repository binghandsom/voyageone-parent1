/**
 * SalesOrderCancelRequestParam.java
 *
...
/**
 *  SalesOrderCancelRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SalesOrderCancelRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "salesOrderCancelRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":salesOrderCancelRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderCancelRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SalesOrderCancelRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            SalesOrderCancelRequestParam object = new SalesOrderCancelRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"salesOrderCancelRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SalesOrderCancelRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
