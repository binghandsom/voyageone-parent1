/**
 * ShoppingCartExternalIdRequestParam.java
 *
...
/**
 *  ShoppingCartExternalIdRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ShoppingCartExternalIdRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "shoppingCartExternalIdRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":shoppingCartExternalIdRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "shoppingCartExternalIdRequestParam", xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "externalId"));
    ...
    public static class Factory {
         ...
         */
        public static ShoppingCartExternalIdRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ShoppingCartExternalIdRequestParam object = new ShoppingCartExternalIdRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"shoppingCartExternalIdRequestParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ShoppingCartExternalIdRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
