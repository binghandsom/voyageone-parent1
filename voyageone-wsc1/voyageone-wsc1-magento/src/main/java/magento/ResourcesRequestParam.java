...
/**
 *  ResourcesRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ResourcesRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "resourcesRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":resourcesRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "resourcesRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ResourcesRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ResourcesRequestParam object = new ResourcesRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"resourcesRequestParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ResourcesRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
