/**
 * CatalogCategoryInfoRequestParam.java
 *
...
/**
 *  CatalogCategoryInfoRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryInfoRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogCategoryInfoRequestParam", "ns1");
     ...
     */
    protected magento.ArrayOfString localAttributes;
     ...
     */
    public magento.ArrayOfString getAttributes() {
     ...
     */
    public void setAttributes(magento.ArrayOfString param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogCategoryInfoRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryInfoRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogCategoryInfoRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogCategoryInfoRequestParam object = new CatalogCategoryInfoRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogCategoryInfoRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogCategoryInfoRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "attributes").equals(
                            reader.getName())) {
                    object.setAttributes(magento.ArrayOfString.Factory.parse(
                            reader));
