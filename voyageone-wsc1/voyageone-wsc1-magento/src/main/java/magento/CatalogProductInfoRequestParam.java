/**
 * CatalogProductInfoRequestParam.java
 *
...
/**
 *  CatalogProductInfoRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductInfoRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductInfoRequestParam", "ns1");
     ...
     */
    protected magento.CatalogProductRequestAttributes localAttributes;
    ...
    /**
     * Auto generated getter method
     * @return magento.CatalogProductRequestAttributes
     */
    public magento.CatalogProductRequestAttributes getAttributes() {
     ...
     */
    public void setAttributes(magento.CatalogProductRequestAttributes param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogProductInfoRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductInfoRequestParam", xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localAttributesTracker) {
            elementList.add(new javax.xml.namespace.QName("", "attributes"));
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductInfoRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogProductInfoRequestParam object = new CatalogProductInfoRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductInfoRequestParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductInfoRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "attributes").equals(
                            reader.getName())) {
                    object.setAttributes(magento.CatalogProductRequestAttributes.Factory.parse(
                            reader));
