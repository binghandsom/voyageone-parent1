...
/**
 *  CatalogProductSetSpecialPriceRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductSetSpecialPriceRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductSetSpecialPriceRequestParam", "ns1");
     ...
     */
    protected java.lang.String localSpecialPrice;
    ...
    public boolean isSpecialPriceSpecified() {
        return localSpecialPriceTracker;
    }
     ...
     */
    public void setSpecialPrice(java.lang.String param) {
        localSpecialPriceTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductSetSpecialPriceRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductSetSpecialPriceRequestParam", xmlWriter);
        ...
        if (localSpecialPriceTracker) {
            namespace = "";
            writeStartElement(null, namespace, "specialPrice", xmlWriter);

            if (localSpecialPrice == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "specialPrice cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localSpecialPrice);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSpecialPriceTracker) {
            elementList.add(new javax.xml.namespace.QName("", "specialPrice"));
        ...
        if (localFromDateTracker) {
            elementList.add(new javax.xml.namespace.QName("", "fromDate"));
        ...
        if (localToDateTracker) {
            elementList.add(new javax.xml.namespace.QName("", "toDate"));
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductSetSpecialPriceRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogProductSetSpecialPriceRequestParam object = new CatalogProductSetSpecialPriceRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductSetSpecialPriceRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductSetSpecialPriceRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "specialPrice").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "specialPrice" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setSpecialPrice(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
