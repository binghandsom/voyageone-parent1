...
/**
 *  GiftcardCustomerEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GiftcardCustomerEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = giftcardCustomerEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":giftcardCustomerEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "giftcardCustomerEntity", xmlWriter);
            }
        }
