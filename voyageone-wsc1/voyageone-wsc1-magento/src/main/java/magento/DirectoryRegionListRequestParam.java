/**
 * DirectoryRegionListRequestParam.java
 *
...
/**
 *  DirectoryRegionListRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DirectoryRegionListRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "directoryRegionListRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":directoryRegionListRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "directoryRegionListRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DirectoryRegionListRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            DirectoryRegionListRequestParam object = new DirectoryRegionListRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"directoryRegionListRequestParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DirectoryRegionListRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
