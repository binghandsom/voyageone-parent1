...
/**
 *  SalesOrderCreditmemoAddCommentRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SalesOrderCreditmemoAddCommentRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "salesOrderCreditmemoAddCommentRequestParam", "ns1");
     ...
     */
    protected String localCreditmemoIncrementId;
    ...
    /**
     * Auto generated setter method
     * @param param CreditmemoIncrementId
     */
    public void setCreditmemoIncrementId(String param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":salesOrderCreditmemoAddCommentRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderCreditmemoAddCommentRequestParam", xmlWriter);
        ...
        if (localCreditmemoIncrementId == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "creditmemoIncrementId cannot be null!!");
        } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localNotifyCustomerTracker) {
            elementList.add(new javax.xml.namespace.QName("", "notifyCustomer"));
    ...
    public static class Factory {
         ...
         */
        public static SalesOrderCreditmemoAddCommentRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            SalesOrderCreditmemoAddCommentRequestParam object = new SalesOrderCreditmemoAddCommentRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"salesOrderCreditmemoAddCommentRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SalesOrderCreditmemoAddCommentRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("",
                            "creditmemoIncrementId").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "creditmemoIncrementId" +
                            "  cannot be null");
                    }

                    String content = reader.getElementText();

                    object.setCreditmemoIncrementId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "notifyCustomer").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
