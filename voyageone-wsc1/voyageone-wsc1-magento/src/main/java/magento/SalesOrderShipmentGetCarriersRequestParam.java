/**
 * SalesOrderShipmentGetCarriersRequestParam.java
 *
...
/**
 *  SalesOrderShipmentGetCarriersRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SalesOrderShipmentGetCarriersRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "salesOrderShipmentGetCarriersRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":salesOrderShipmentGetCarriersRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderShipmentGetCarriersRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static SalesOrderShipmentGetCarriersRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            SalesOrderShipmentGetCarriersRequestParam object = new SalesOrderShipmentGetCarriersRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"salesOrderShipmentGetCarriersRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SalesOrderShipmentGetCarriersRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
