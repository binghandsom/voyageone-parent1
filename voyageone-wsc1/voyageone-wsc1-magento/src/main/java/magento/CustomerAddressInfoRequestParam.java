/**
 * CustomerAddressInfoRequestParam.java
 *
...
/**
 *  CustomerAddressInfoRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerAddressInfoRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "customerAddressInfoRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":customerAddressInfoRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "customerAddressInfoRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CustomerAddressInfoRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerAddressInfoRequestParam object = new CustomerAddressInfoRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerAddressInfoRequestParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CustomerAddressInfoRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
