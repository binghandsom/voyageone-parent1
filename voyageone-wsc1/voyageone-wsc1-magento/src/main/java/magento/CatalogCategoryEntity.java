...
/**
 *  CatalogCategoryEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryEntity implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected int localCategory_id;

    /**
     * field for Parent_id
     */
    protected int localParent_id;
     ...
     * field for Children
     */
    protected magento.ArrayOfCatalogCategoryEntities localChildren;
     ...
     */
    public void setCategory_id(int param) {
     ...
     */
    public void setParent_id(int param) {
    ...
    /**
     * Auto generated getter method
     * @return magento.ArrayOfCatalogCategoryEntities
     */
    public magento.ArrayOfCatalogCategoryEntities getChildren() {
     ...
     */
    public void setChildren(magento.ArrayOfCatalogCategoryEntities param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogCategoryEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogCategoryEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogCategoryEntity object = new CatalogCategoryEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogCategoryEntity".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogCategoryEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "children").equals(
                            reader.getName())) {
                    object.setChildren(magento.ArrayOfCatalogCategoryEntities.Factory.parse(
                            reader));
