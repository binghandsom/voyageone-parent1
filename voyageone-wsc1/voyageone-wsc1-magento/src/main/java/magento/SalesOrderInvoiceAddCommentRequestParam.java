...
/**
 *  SalesOrderInvoiceAddCommentRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SalesOrderInvoiceAddCommentRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "salesOrderInvoiceAddCommentRequestParam", "ns1");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":salesOrderInvoiceAddCommentRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderInvoiceAddCommentRequestParam", xmlWriter);
        ...
        namespace = "";
        writeStartElement(null, namespace, "invoiceIncrementId", xmlWriter);

        if (localInvoiceIncrementId == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "invoiceIncrementId cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localInvoiceIncrementId);
        }
        ...
        if (localIncludeCommentTracker) {
            ...
            if (localIncludeComment == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "includeComment cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localIncludeComment);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "invoiceIncrementId"));

        if (localInvoiceIncrementId != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localInvoiceIncrementId));
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "invoiceIncrementId cannot be null!!");
        }
    ...
    public static class Factory {
         ...
         */
        public static SalesOrderInvoiceAddCommentRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            SalesOrderInvoiceAddCommentRequestParam object = new SalesOrderInvoiceAddCommentRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"salesOrderInvoiceAddCommentRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SalesOrderInvoiceAddCommentRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "invoiceIncrementId").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "invoiceIncrementId" +
                            "  cannot be null");
                    }
