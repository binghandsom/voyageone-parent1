/**
 * ShoppingCartGiftcardListRequestParam.java
 *
...
/**
 *  ShoppingCartGiftcardListRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ShoppingCartGiftcardListRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "shoppingCartGiftcardListRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":shoppingCartGiftcardListRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "shoppingCartGiftcardListRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ShoppingCartGiftcardListRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ShoppingCartGiftcardListRequestParam object = new ShoppingCartGiftcardListRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"shoppingCartGiftcardListRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ShoppingCartGiftcardListRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
