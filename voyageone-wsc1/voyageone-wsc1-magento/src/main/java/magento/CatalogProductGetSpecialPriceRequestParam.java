...
/**
 *  CatalogProductGetSpecialPriceRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductGetSpecialPriceRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductGetSpecialPriceRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductGetSpecialPriceRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductGetSpecialPriceRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductGetSpecialPriceRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductGetSpecialPriceRequestParam object = new CatalogProductGetSpecialPriceRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductGetSpecialPriceRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductGetSpecialPriceRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
