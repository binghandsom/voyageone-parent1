/**
 * ShoppingCartProductCustomPriceEntity.java
 *
...
/**
 *  ShoppingCartProductCustomPriceEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ShoppingCartProductCustomPriceEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = shoppingCartProductCustomPriceEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":shoppingCartProductCustomPriceEntity",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "shoppingCartProductCustomPriceEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ShoppingCartProductCustomPriceEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ShoppingCartProductCustomPriceEntity object = new ShoppingCartProductCustomPriceEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"shoppingCartProductCustomPriceEntity".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ShoppingCartProductCustomPriceEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
