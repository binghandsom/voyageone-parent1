...
/**
 *  CatalogProductAttributeEntityToUpdate bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductAttributeEntityToUpdate implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = catalogProductAttributeEntityToUpdate
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogProductAttributeEntityToUpdate",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductAttributeEntityToUpdate", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductAttributeEntityToUpdate parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductAttributeEntityToUpdate object = new CatalogProductAttributeEntityToUpdate();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductAttributeEntityToUpdate".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductAttributeEntityToUpdate) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
