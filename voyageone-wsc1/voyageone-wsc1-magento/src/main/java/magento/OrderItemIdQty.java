...
/**
 *  OrderItemIdQty bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class OrderItemIdQty implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected int localOrder_item_id;
     ...
     */
    public void setOrder_item_id(int param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":orderItemIdQty", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "orderItemIdQty", xmlWriter);
            }
        }
        ...
        if (localOrder_item_id == java.lang.Integer.MIN_VALUE) {
    ...
    public static class Factory {
         ...
         */
        public static OrderItemIdQty parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            OrderItemIdQty object = new OrderItemIdQty();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"orderItemIdQty".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (OrderItemIdQty) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setOrder_item_id(org.apache.axis2.databinding.utils.ConverterUtil.convertToInt(
                            content));
