/**
 * CatalogProductTagRemoveRequestParam.java
 *
...
/**
 *  CatalogProductTagRemoveRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductTagRemoveRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductTagRemoveRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogProductTagRemoveRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductTagRemoveRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductTagRemoveRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductTagRemoveRequestParam object = new CatalogProductTagRemoveRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductTagRemoveRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductTagRemoveRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
