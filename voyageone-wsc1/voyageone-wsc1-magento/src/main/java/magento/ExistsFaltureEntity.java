...
/**
 *  ExistsFaltureEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExistsFaltureEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = existsFaltureEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":existsFaltureEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "existsFaltureEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ExistsFaltureEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ExistsFaltureEntity object = new ExistsFaltureEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"existsFaltureEntity".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExistsFaltureEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
