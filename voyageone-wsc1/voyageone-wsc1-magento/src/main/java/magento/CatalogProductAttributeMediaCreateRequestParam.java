...
/**
 *  CatalogProductAttributeMediaCreateRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductAttributeMediaCreateRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductAttributeMediaCreateRequestParam", "ns1");
     ...
     * field for Data
     */
    protected magento.CatalogProductAttributeMediaCreateEntity localData;
    ...
    /**
     * Auto generated getter method
     * @return magento.CatalogProductAttributeMediaCreateEntity
     */
    public magento.CatalogProductAttributeMediaCreateEntity getData() {
        return localData;
    }
     ...
     * @param param Data
     */
    public void setData(magento.CatalogProductAttributeMediaCreateEntity param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductAttributeMediaCreateRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductAttributeMediaCreateRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductAttributeMediaCreateRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogProductAttributeMediaCreateRequestParam object = new CatalogProductAttributeMediaCreateRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductAttributeMediaCreateRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductAttributeMediaCreateRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(magento.CatalogProductAttributeMediaCreateEntity.Factory.parse(
                            reader));
