...
/**
 *  LoginResponseParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class LoginResponseParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "loginResponseParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":loginResponseParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "loginResponseParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static LoginResponseParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            LoginResponseParam object = new LoginResponseParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"loginResponseParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (LoginResponseParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
