/**
 * CatalogCategoryUpdateProductRequestParam.java
 *
...
/**
 *  CatalogCategoryUpdateProductRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryUpdateProductRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogCategoryUpdateProductRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogCategoryUpdateProductRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryUpdateProductRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogCategoryUpdateProductRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogCategoryUpdateProductRequestParam object = new CatalogCategoryUpdateProductRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogCategoryUpdateProductRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogCategoryUpdateProductRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
