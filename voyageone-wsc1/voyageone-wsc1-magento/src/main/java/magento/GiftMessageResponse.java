...
/**
 *  GiftMessageResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GiftMessageResponse implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = giftMessageResponse
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":giftMessageResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "giftMessageResponse", xmlWriter);
            }
        }
        ...
        public static GiftMessageResponse parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "entityId").equals(
                            reader.getName())) {
