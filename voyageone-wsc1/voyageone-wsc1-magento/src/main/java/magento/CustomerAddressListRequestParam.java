/**
 * CustomerAddressListRequestParam.java
 *
...
/**
 *  CustomerAddressListRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerAddressListRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "customerAddressListRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":customerAddressListRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "customerAddressListRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CustomerAddressListRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CustomerAddressListRequestParam object = new CustomerAddressListRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerAddressListRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CustomerAddressListRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
