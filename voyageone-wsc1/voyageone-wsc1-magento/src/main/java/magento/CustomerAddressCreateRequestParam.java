...
/**
 *  CustomerAddressCreateRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerAddressCreateRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "customerAddressCreateRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":customerAddressCreateRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "customerAddressCreateRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CustomerAddressCreateRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CustomerAddressCreateRequestParam object = new CustomerAddressCreateRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerAddressCreateRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CustomerAddressCreateRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
