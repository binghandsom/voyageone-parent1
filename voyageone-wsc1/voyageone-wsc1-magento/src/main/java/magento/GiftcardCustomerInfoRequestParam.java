/**
 * GiftcardCustomerInfoRequestParam.java
 *
...
/**
 *  GiftcardCustomerInfoRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GiftcardCustomerInfoRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "giftcardCustomerInfoRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":giftcardCustomerInfoRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "giftcardCustomerInfoRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GiftcardCustomerInfoRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            GiftcardCustomerInfoRequestParam object = new GiftcardCustomerInfoRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"giftcardCustomerInfoRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GiftcardCustomerInfoRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
