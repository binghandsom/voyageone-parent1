...
/**
 *  SalesOrderStatusHistoryEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SalesOrderStatusHistoryEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = salesOrderStatusHistoryEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":salesOrderStatusHistoryEntity",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderStatusHistoryEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static SalesOrderStatusHistoryEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            SalesOrderStatusHistoryEntity object = new SalesOrderStatusHistoryEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"salesOrderStatusHistoryEntity".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SalesOrderStatusHistoryEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
