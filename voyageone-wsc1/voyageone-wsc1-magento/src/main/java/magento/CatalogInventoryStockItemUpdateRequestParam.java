...
/**
 *  CatalogInventoryStockItemUpdateRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogInventoryStockItemUpdateRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogInventoryStockItemUpdateRequestParam", "ns1");
     ...
     * field for Data
     */
    protected magento.CatalogInventoryStockItemUpdateEntity localData;
     ...
     */
    public magento.CatalogInventoryStockItemUpdateEntity getData() {
        return localData;
    }
     ...
     * @param param Data
     */
    public void setData(magento.CatalogInventoryStockItemUpdateEntity param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogInventoryStockItemUpdateRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogInventoryStockItemUpdateRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogInventoryStockItemUpdateRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogInventoryStockItemUpdateRequestParam object = new CatalogInventoryStockItemUpdateRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogInventoryStockItemUpdateRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogInventoryStockItemUpdateRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(magento.CatalogInventoryStockItemUpdateEntity.Factory.parse(
                            reader));
