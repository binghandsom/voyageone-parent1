...
/**
 *  EndSessionResponseParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EndSessionResponseParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "endSessionResponseParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":endSessionResponseParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "endSessionResponseParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EndSessionResponseParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EndSessionResponseParam object = new EndSessionResponseParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"endSessionResponseParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EndSessionResponseParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
