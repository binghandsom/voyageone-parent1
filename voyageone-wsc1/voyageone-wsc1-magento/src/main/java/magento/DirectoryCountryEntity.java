...
/**
 *  DirectoryCountryEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DirectoryCountryEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = directoryCountryEntity
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":directoryCountryEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "directoryCountryEntity", xmlWriter);
            }
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "iso2_code", xmlWriter);

        if (localIso2_code == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "iso2_code cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localIso2_code);
        }

        xmlWriter.writeEndElement();

        namespace = "";
        writeStartElement(null, namespace, "iso3_code", xmlWriter);

        if (localIso3_code == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "iso3_code cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localIso3_code);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "iso2_code"));
        ...
        elementList.add(new javax.xml.namespace.QName("", "iso3_code"));
    ...
    public static class Factory {
        ...
        public static DirectoryCountryEntity parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "iso2_code").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "iso3_code").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
