...
public class SalesOrderCreditmemoCreateRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "salesOrderCreditmemoCreateRequestParam", "ns1");
     ...
     */
    protected magento.SalesOrderCreditmemoData localCreditmemoData;
    ...
    /**
     * Auto generated getter method
     * @return magento.SalesOrderCreditmemoData
     */
    public magento.SalesOrderCreditmemoData getCreditmemoData() {
        return localCreditmemoData;
    }

    /**
     * Auto generated setter method
     * @param param CreditmemoData
     */
    public void setCreditmemoData(magento.SalesOrderCreditmemoData param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":salesOrderCreditmemoCreateRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderCreditmemoCreateRequestParam", xmlWriter);
        ...
        if (localCreditmemoDataTracker) {
            if (localCreditmemoData == null) {
                throw new org.apache.axis2.databinding.ADBException(
                    "creditmemoData cannot be null!!");
            }

            localCreditmemoData.serialize(new javax.xml.namespace.QName("",
                    "creditmemoData"), xmlWriter);
        }
        ...
        if (localRefundToStoreCreditAmountTracker) {
            namespace = "";
            writeStartElement(null, namespace, "refundToStoreCreditAmount",
                xmlWriter);

            if (localRefundToStoreCreditAmount == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "refundToStoreCreditAmount cannot be null!!");
            } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localCreditmemoDataTracker) {
            elementList.add(new javax.xml.namespace.QName("", "creditmemoData"));
            ...
            elementList.add(localCreditmemoData);
        }
        ...
        if (localRefundToStoreCreditAmountTracker) {
            ...
            if (localRefundToStoreCreditAmount != null) {
                elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                        localRefundToStoreCreditAmount));
            } else {
                throw new org.apache.axis2.databinding.ADBException(
                    "refundToStoreCreditAmount cannot be null!!");
            }
    ...
    public static class Factory {
        ...
        public static SalesOrderCreditmemoCreateRequestParam parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "creditmemoData").equals(
                            reader.getName())) {
                    object.setCreditmemoData(magento.SalesOrderCreditmemoData.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("",
                            "refundToStoreCreditAmount").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "refundToStoreCreditAmount" +
                            "  cannot be null");
                    }
