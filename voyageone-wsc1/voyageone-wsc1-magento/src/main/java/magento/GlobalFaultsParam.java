...
/**
 *  GlobalFaultsParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GlobalFaultsParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "globalFaultsParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":globalFaultsParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "globalFaultsParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GlobalFaultsParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GlobalFaultsParam object = new GlobalFaultsParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"globalFaultsParam".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GlobalFaultsParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
