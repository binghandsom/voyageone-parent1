/**
 * CatalogCategoryAssignedProductsRequestParam.java
 *
...
/**
 *  CatalogCategoryAssignedProductsRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryAssignedProductsRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogCategoryAssignedProductsRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogCategoryAssignedProductsRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryAssignedProductsRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogCategoryAssignedProductsRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogCategoryAssignedProductsRequestParam object = new CatalogCategoryAssignedProductsRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogCategoryAssignedProductsRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogCategoryAssignedProductsRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
