...
/**
 *  CatalogProductAttributeTierPriceUpdateRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductAttributeTierPriceUpdateRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductAttributeTierPriceUpdateRequestParam", "ns1");
    ...
    /**
     * field for TierPrices
     */
    protected magento.CatalogProductTierPriceEntityArray localTierPrices;
     ...
     */
    public magento.CatalogProductTierPriceEntityArray getTierPrices() {
        return localTierPrices;
    }

    /**
     * Auto generated setter method
     * @param param TierPrices
     */
    public void setTierPrices(magento.CatalogProductTierPriceEntityArray param) {
        this.localTierPrices = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductAttributeTierPriceUpdateRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localTierPrices == null) {
            throw new org.apache.axis2.databinding.ADBException(
                "tierPrices cannot be null!!");
        }

        localTierPrices.serialize(new javax.xml.namespace.QName("", "tierPrices"),
            xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "tierPrices"));
        ...
        elementList.add(localTierPrices);
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductAttributeTierPriceUpdateRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductAttributeTierPriceUpdateRequestParam object = new CatalogProductAttributeTierPriceUpdateRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductAttributeTierPriceUpdateRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductAttributeTierPriceUpdateRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "tierPrices").equals(
                            reader.getName())) {
                    object.setTierPrices(magento.CatalogProductTierPriceEntityArray.Factory.parse(
                            reader));
