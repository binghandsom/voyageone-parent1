...
/**
 *  CatalogProductCustomOptionValueListEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductCustomOptionValueListEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = catalogProductCustomOptionValueListEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductCustomOptionValueListEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductCustomOptionValueListEntity", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductCustomOptionValueListEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductCustomOptionValueListEntity object = new CatalogProductCustomOptionValueListEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductCustomOptionValueListEntity".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductCustomOptionValueListEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
