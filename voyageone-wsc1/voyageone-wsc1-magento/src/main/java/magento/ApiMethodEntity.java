...
/**
 *  ApiMethodEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ApiMethodEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = apiMethodEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":apiMethodEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "apiMethodEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ApiMethodEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ApiMethodEntity object = new ApiMethodEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"apiMethodEntity".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ApiMethodEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
