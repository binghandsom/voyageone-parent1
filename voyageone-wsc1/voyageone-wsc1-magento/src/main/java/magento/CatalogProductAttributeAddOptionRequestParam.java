...
/**
 *  CatalogProductAttributeAddOptionRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductAttributeAddOptionRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductAttributeAddOptionRequestParam", "ns1");
     ...
     * field for Data
     */
    protected magento.CatalogProductAttributeOptionEntityToAdd localData;
    ...
    /**
     * Auto generated getter method
     * @return magento.CatalogProductAttributeOptionEntityToAdd
     */
    public magento.CatalogProductAttributeOptionEntityToAdd getData() {
        return localData;
    }
     ...
     * @param param Data
     */
    public void setData(magento.CatalogProductAttributeOptionEntityToAdd param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductAttributeAddOptionRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductAttributeAddOptionRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductAttributeAddOptionRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogProductAttributeAddOptionRequestParam object = new CatalogProductAttributeAddOptionRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductAttributeAddOptionRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductAttributeAddOptionRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(magento.CatalogProductAttributeOptionEntityToAdd.Factory.parse(
                            reader));
