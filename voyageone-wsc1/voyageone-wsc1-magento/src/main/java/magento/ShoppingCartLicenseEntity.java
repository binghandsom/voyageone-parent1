...
/**
 *  ShoppingCartLicenseEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ShoppingCartLicenseEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = shoppingCartLicenseEntity
     ...
     */
    protected boolean localAgreement_idTracker = false;
     ...
     * field for Is_html
     */
    protected int localIs_html;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localIs_htmlTracker = false;

    public boolean isAgreement_idSpecified() {
        return localAgreement_idTracker;
    }
    ...
    public boolean isIs_htmlSpecified() {
        return localIs_htmlTracker;
    }
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":shoppingCartLicenseEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "shoppingCartLicenseEntity", xmlWriter);
            }
        }

        if (localAgreement_idTracker) {
            namespace = "";
            writeStartElement(null, namespace, "agreement_id", xmlWriter);

            if (localAgreement_id == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "agreement_id cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localAgreement_id);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localAgreement_idTracker) {
            elementList.add(new javax.xml.namespace.QName("", "agreement_id"));
        ...
        if (localIs_htmlTracker) {
            elementList.add(new javax.xml.namespace.QName("", "is_html"));
        ...
        public static ShoppingCartLicenseEntity parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "agreement_id").equals(
                            reader.getName())) {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "is_html").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
