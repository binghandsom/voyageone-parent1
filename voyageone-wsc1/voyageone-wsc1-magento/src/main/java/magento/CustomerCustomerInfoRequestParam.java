/**
 * CustomerCustomerInfoRequestParam.java
 *
...
/**
 *  CustomerCustomerInfoRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerCustomerInfoRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "customerCustomerInfoRequestParam", "ns1");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":customerCustomerInfoRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "customerCustomerInfoRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CustomerCustomerInfoRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CustomerCustomerInfoRequestParam object = new CustomerCustomerInfoRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"customerCustomerInfoRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CustomerCustomerInfoRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
