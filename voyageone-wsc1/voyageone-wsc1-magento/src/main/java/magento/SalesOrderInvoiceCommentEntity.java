...
/**
 *  SalesOrderInvoiceCommentEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class SalesOrderInvoiceCommentEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = salesOrderInvoiceCommentEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":salesOrderInvoiceCommentEntity",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "salesOrderInvoiceCommentEntity", xmlWriter);
            }
        }
