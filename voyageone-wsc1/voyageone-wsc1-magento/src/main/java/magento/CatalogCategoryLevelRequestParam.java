...
/**
 *  CatalogCategoryLevelRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryLevelRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogCategoryLevelRequestParam", "ns1");
     ...
     */
    protected String localCategoryId;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogCategoryLevelRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryLevelRequestParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogCategoryLevelRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogCategoryLevelRequestParam object = new CatalogCategoryLevelRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogCategoryLevelRequestParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogCategoryLevelRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "website").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setCategoryId(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
