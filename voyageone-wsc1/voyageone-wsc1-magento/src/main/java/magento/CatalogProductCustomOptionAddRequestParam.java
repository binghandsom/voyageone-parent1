...
/**
 *  CatalogProductCustomOptionAddRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductCustomOptionAddRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogProductCustomOptionAddRequestParam", "ns1");
     ...
     * field for Data
     */
    protected magento.CatalogProductCustomOptionToAdd localData;
    ...
    /**
     * Auto generated getter method
     * @return magento.CatalogProductCustomOptionToAdd
     */
    public magento.CatalogProductCustomOptionToAdd getData() {
        return localData;
    }
     ...
     * @param param Data
     */
    public void setData(magento.CatalogProductCustomOptionToAdd param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductCustomOptionAddRequestParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductCustomOptionAddRequestParam", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductCustomOptionAddRequestParam parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogProductCustomOptionAddRequestParam object = new CatalogProductCustomOptionAddRequestParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductCustomOptionAddRequestParam".equals(
                                    type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductCustomOptionAddRequestParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "data").equals(
                            reader.getName())) {
                    object.setData(magento.CatalogProductCustomOptionToAdd.Factory.parse(
                            reader));
