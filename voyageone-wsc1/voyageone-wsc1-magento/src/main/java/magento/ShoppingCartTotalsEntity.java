...
/**
 *  ShoppingCartTotalsEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ShoppingCartTotalsEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = shoppingCartTotalsEntity
    ...
    public void setAmount(double param) {
        ...
        localAmountTracker = !Double.isNaN(param);
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":shoppingCartTotalsEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "shoppingCartTotalsEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ShoppingCartTotalsEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            ShoppingCartTotalsEntity object = new ShoppingCartTotalsEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"shoppingCartTotalsEntity".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ShoppingCartTotalsEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
