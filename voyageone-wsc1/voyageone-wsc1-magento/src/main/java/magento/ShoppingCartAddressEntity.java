...
public class ShoppingCartAddressEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = shoppingCartAddressEntity
    ...
    /**
     * Auto generated setter method
     * @param param Save_in_address_book
     */
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":shoppingCartAddressEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "shoppingCartAddressEntity", xmlWriter);
            }
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSame_as_billingTracker) {
            elementList.add(new javax.xml.namespace.QName("", "same_as_billing"));
    ...
    public static class Factory {
        ...
        public static ShoppingCartAddressEntity parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "save_in_address_book").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "save_in_address_book" +
                            "  cannot be null");
                    }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "same_as_billing").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
