...
/**
 *  CatalogProductSpecialPriceReturnEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductSpecialPriceReturnEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = catalogProductSpecialPriceReturnEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix +
                    ":catalogProductSpecialPriceReturnEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductSpecialPriceReturnEntity", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "special_from_date"));
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductSpecialPriceReturnEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductSpecialPriceReturnEntity object = new CatalogProductSpecialPriceReturnEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductSpecialPriceReturnEntity".equals(
                                    type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductSpecialPriceReturnEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
