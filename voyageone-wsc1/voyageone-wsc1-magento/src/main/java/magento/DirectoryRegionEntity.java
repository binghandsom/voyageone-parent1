...
/**
 *  DirectoryRegionEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class DirectoryRegionEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = directoryRegionEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":directoryRegionEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "directoryRegionEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static DirectoryRegionEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            DirectoryRegionEntity object = new DirectoryRegionEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"directoryRegionEntity".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (DirectoryRegionEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
