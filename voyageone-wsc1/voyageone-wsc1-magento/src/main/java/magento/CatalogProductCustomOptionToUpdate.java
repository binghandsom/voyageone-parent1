...
/**
 *  CatalogProductCustomOptionToUpdate bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductCustomOptionToUpdate implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = catalogProductCustomOptionToUpdate
    ...
    public void setIs_require(int param) {
        ...
        localIs_requireTracker = param != Integer.MIN_VALUE;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogProductCustomOptionToUpdate",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductCustomOptionToUpdate", xmlWriter);
            }
        }
        ...
        if (localIs_requireTracker) {
            ...
            if (localIs_require == Integer.MIN_VALUE) {
                throw new org.apache.axis2.databinding.ADBException(
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductCustomOptionToUpdate parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductCustomOptionToUpdate object = new CatalogProductCustomOptionToUpdate();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductCustomOptionToUpdate".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductCustomOptionToUpdate) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setIs_require(Integer.MIN_VALUE);
                }
