...
/**
 *  EndSessionParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EndSessionParam implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":endSessionParam", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "endSessionParam", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EndSessionParam parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            EndSessionParam object = new EndSessionParam();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"endSessionParam".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EndSessionParam) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
