...
/**
 *  CatalogCategoryMoveRequestParam bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogCategoryMoveRequestParam implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("urn:Magento",
            "catalogCategoryMoveRequestParam", "ns1");
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogCategoryMoveRequestParam",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogCategoryMoveRequestParam", xmlWriter);
            }
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "afterId", xmlWriter);

        if (localAfterId == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "afterId cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localAfterId);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "afterId"));
    ...
    public static class Factory {
        ...
        public static CatalogCategoryMoveRequestParam parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "afterId").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
