...
/**
 *  EnterpriseGiftcardaccountListEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EnterpriseGiftcardaccountListEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = enterpriseGiftcardaccountListEntity
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":enterpriseGiftcardaccountListEntity",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "enterpriseGiftcardaccountListEntity", xmlWriter);
            }
        }

        namespace = "";
        writeStartElement(null, namespace, "giftcardaccount_id", xmlWriter);

        if (localGiftcardaccount_id == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "giftcardaccount_id cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localGiftcardaccount_id);
        }
        ...
        namespace = "";
        writeStartElement(null, namespace, "used_amount", xmlWriter);

        if (localUsed_amount == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "used_amount cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localUsed_amount);
        }

        xmlWriter.writeEndElement();

        namespace = "";
        writeStartElement(null, namespace, "base_amount", xmlWriter);

        if (localBase_amount == null) {
            // write the nil attribute
            throw new org.apache.axis2.databinding.ADBException(
                "base_amount cannot be null!!");
        } else {
            xmlWriter.writeCharacters(localBase_amount);
        }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        elementList.add(new javax.xml.namespace.QName("", "giftcardaccount_id"));

        if (localGiftcardaccount_id != null) {
            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localGiftcardaccount_id));
        } else {
            throw new org.apache.axis2.databinding.ADBException(
                "giftcardaccount_id cannot be null!!");
        }
        ...
        elementList.add(new javax.xml.namespace.QName("", "used_amount"));
        ...
        elementList.add(new javax.xml.namespace.QName("", "base_amount"));
        ...
        public static EnterpriseGiftcardaccountListEntity parse(
            ...
            try {
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "giftcardaccount_id").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "giftcardaccount_id" +
                            "  cannot be null");
                    }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "used_amount").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "base_amount").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
