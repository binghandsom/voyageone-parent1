...
/**
 *  CatalogProductRequestAttributes bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductRequestAttributes implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = catalogProductRequestAttributes
     ...
     */
    protected magento.ArrayOfString localAdditional_attributes;
     ...
     * @return magento.ArrayOfString
     */
    public magento.ArrayOfString getAdditional_attributes() {
     ...
     */
    public void setAdditional_attributes(magento.ArrayOfString param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogProductRequestAttributes",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductRequestAttributes", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductRequestAttributes parse(
            javax.xml.stream.XMLStreamReader reader) throws Exception {
            CatalogProductRequestAttributes object = new CatalogProductRequestAttributes();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductRequestAttributes".equals(type)) {
                            //find namespace for the prefix
                            String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductRequestAttributes) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setAdditional_attributes(magento.ArrayOfString.Factory.parse(
                            reader));
