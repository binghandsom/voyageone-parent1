...
/**
 *  GiftMessageEntity bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GiftMessageEntity implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = giftMessageEntity
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":giftMessageEntity", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "giftMessageEntity", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static GiftMessageEntity parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            GiftMessageEntity object = new GiftMessageEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"giftMessageEntity".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (GiftMessageEntity) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
