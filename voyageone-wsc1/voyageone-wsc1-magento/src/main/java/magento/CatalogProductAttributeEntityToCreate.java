...
/**
 *  CatalogProductAttributeEntityToCreate bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CatalogProductAttributeEntityToCreate implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = catalogProductAttributeEntityToCreate
     ...
     *   in the serialized XML
     */
    protected boolean localFrontend_labelTracker = false;
    ...
    public boolean isFrontend_labelSpecified() {
        return localFrontend_labelTracker;
    }
    ...
    public void setFrontend_label(
        ...
        localFrontend_labelTracker = param != null;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":catalogProductAttributeEntityToCreate",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "catalogProductAttributeEntityToCreate", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static CatalogProductAttributeEntityToCreate parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CatalogProductAttributeEntityToCreate object = new CatalogProductAttributeEntityToCreate();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"catalogProductAttributeEntityToCreate".equals(
                                    type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CatalogProductAttributeEntityToCreate) magento.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
