				              	  	...
				              	  	<h3 class="panel-title">
				              	  		<div class="row">
				              	  			...
				              	  			<div class="col-lg-3">
									                ...
									                <input type="radio" id="model_radioset" name="product_sku_radioset" checked="checked" class="ui-helper-hidden-accessible"/>
									                <label for="model_radioset" class="ui-button ui-widget ui-state-default ui-button-text-only ui-corner-left ui-state-active" role="button" aria-disabled="false" aria-pressed="true">
														<span class="ui-button-text">Model</span>
									                </label>
									                <input type="radio" id="product_radioset" name="product_sku_radioset" class="ui-helper-hidden-accessible"/>
									                <label for="product_radioset" class="ui-button ui-widget ui-state-default ui-button-text-only" role="button" aria-disabled="false" aria-pressed="false">
