...
// 页面初期化用
public class AjaxFinancialOfficialTaxReportBean extends AjaxRequestBean {

    public class Result extends AjaxResponseBean {
        // 月度报表请求
        private List<OfficialTaxBean> officialTaxBean;

        public List<OfficialTaxBean> getOfficialTaxBean() {
            return officialTaxBean;
        }

        public void setOfficialTaxBean(List<OfficialTaxBean> officialTaxBean) {
            this.officialTaxBean = officialTaxBean;
        }
    ...
    public String getPort_ids() {
        return port_ids;
    }

    public void setPort_ids(String port_ids) {
        this.port_ids = port_ids;
    }
