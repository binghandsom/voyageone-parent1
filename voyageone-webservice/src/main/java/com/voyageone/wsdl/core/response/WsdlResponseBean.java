package com.voyageone.wsdl.core.response;
...
import com.voyageone.wsdl.core.exception.SystemException;
import com.voyageone.wsdl.core.init.MessageHelp;
...
public class WsdlResponseBean {
	...
	public <T extends WsdlResponseBean> T setResult(boolean result, String msgCode, int msgType) {
		// 结果
		setResult(result);
		// 消息代码
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T extends WsdlResponseBean> T setResult(boolean result, int msgType, String msg) {
		// 结果
		setResult(result);
		// 附带信息
		if (!StringUtils.isEmpty(msg)) {
