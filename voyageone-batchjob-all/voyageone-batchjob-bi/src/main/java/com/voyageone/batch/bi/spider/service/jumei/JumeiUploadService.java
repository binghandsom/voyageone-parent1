 ...
 */
public interface JumeiUploadService {

    void uploadProduct(WebDriver driver, JumeiProductBean jumeiProductBean, List<JumeiSkuBean> skuLst) throws Exception;

    void uploadDeal(WebDriver driver, String strPID, JumeiDealBean jumeiDealBean, List<JumeiSkuBean> skuLst) throws Exception;
