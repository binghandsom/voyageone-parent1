...
VALUES
  ...
  ('012', '', '', 0, 0, 'Product 级别', 'product_p_name', 'LEFT(MAKTX, LOCATE('','', MAKTX, LOCATE('','', MAKTX) + 1) - 1)'),
  ('012', '', '', 0, 0, 'Product 级别', 'product_p_color', 'COLOR_ATWTB'),
  ('012', '', '', 0, 0, 'Product 级别', 'product_p_made_in_country', 'WHERL'),
  ('012', '', '', 0, 0, 'Product 级别', 'product_pe_short_description', 'LEFT(MAKTX, LOCATE('','', MAKTX, LOCATE('','', MAKTX) + 1) - 1)'),
