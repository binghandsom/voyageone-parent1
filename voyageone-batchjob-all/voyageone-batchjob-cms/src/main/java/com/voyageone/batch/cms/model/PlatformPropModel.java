...
public class PlatformPropModel {
    // 第三方平台类目的属性的hash
    ...
    // 可选项列表
    private List<PlatformPropOptionModel> platformPropOptionModelList = new ArrayList<>();
    // 规则列表
    private List<PlatformPropRuleModel> platformPropRuleModelList = new ArrayList<>();
    ...
    public List<PlatformPropOptionModel> getPlatformPropOptionModelList() {
        return platformPropOptionModelList;
    }

    public void setPlatformPropOptionModelList(List<PlatformPropOptionModel> platformPropOptionModelList) {
        this.platformPropOptionModelList = platformPropOptionModelList;
    }

    public List<PlatformPropRuleModel> getPlatformPropRuleModelList() {
        return platformPropRuleModelList;
    }

    public void setPlatformPropRuleModelList(List<PlatformPropRuleModel> platformPropRuleModelList) {
        this.platformPropRuleModelList = platformPropRuleModelList;
    }
}
