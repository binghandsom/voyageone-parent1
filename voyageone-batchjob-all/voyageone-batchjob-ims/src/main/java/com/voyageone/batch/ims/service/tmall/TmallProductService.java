...
//                                    Value valueCheck = value.getValue("std_size_prop_20509_-1");
//                                    if (valueCheck == null) {
//                                        valueCheck = value.getValue("in_prop_148242406");
//                                    }
//
//                                    if (strValue.equals(valueCheck.getValue())) {
...
//                                }
//
//                                if (!lstSortRuleList.contains(valueCheck.getValue())) {
//                                    multiValueNew.add(value);
//                                }
//                            }
//
