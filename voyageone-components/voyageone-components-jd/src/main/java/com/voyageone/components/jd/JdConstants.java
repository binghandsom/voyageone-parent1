...
public class JdConstants {
	...
	// C_JD_RETURN_SUCCESS_OK
	public static final String C_JD_RETURN_SUCCESS_OK = "0";
    // 图片空间操作返回码(1，操作成功)
    public static final String C_JD_IMGZONE_RETURN_SUCCESS_OK = "1";
    // 图片空间操作返回码(0，操作失败)
    public static final String C_JD_IMGZONE_RETURN_SUCCESS_NG = "0";
	// 父属性（有子属性）
