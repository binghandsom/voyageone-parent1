...
public class SneakerHeadBase extends ComponentBase {
    ...
    protected static final String sneakerInfoUrl = "http://10.0.1.24:2233/api/feed/feed_info";
    protected static final String sneakerCountUrl = "http://10.0.1.24:2233/api/feed/feed_sum";
