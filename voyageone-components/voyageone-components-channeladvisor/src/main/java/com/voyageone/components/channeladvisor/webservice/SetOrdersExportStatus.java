 ...
 *         &lt;element name="markAsExported" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = { "accountID", "orderIDList", "clientOrderIdentifierList", "markAsExported" })
@XmlRootElement(name = "SetOrdersExportStatus")
public class SetOrdersExportStatus {
	...
	protected boolean markAsExported;
	...
	/**
	 * Gets the value of the markAsExported property.
	 * 
	 */
	public boolean isMarkAsExported() {
		return markAsExported;
	}

	/**
	 * Sets the value of the markAsExported property.
	 * 
	 */
	public void setMarkAsExported(boolean value) {
		this.markAsExported = value;
	}
