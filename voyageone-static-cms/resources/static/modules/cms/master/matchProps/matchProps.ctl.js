...
define(['modules/cms/cms.module', 'modules/cms/master/matchProps/matchProps.service', 'modules/cms/popup/setMatchValue/popSetMatchValue.ctl', 'css!modules/cms/master/matchProps/matchProps.css'], function(cmsModule) {
  var KEYS, template;
  KEYS = {
  ...
  return angular.module('cmsModule.controllers.matchProps', ['cmsModule']).controller('MatchPropsController', (function() {
    ...
    _Class.prototype.changeIgnore = function(prop) {
      return this.confirm(KEYS.CHANGE).result.then((function(_this) {
        return function() {
          return _this.matchPropsService.setIgnore(prop).then(function() {
            return _this.notify.success(KEYS.SUCCESS);
          });
        };
      })(this), (function(_this) {
        return function() {
          return prop.is_ignore = !prop.is_ignore;
        };
      })(this));
    };
