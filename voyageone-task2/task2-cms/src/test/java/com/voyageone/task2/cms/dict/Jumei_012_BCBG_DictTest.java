 ...
 *  (012)BCBG聚美优品店
 *
 * @author tom on 2016/8/3.
 * @version 2.1.0
 * @since 2.1.0
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration("classpath:context-cms-test.xml")
public class Jumei_012_BCBG_DictTest {
    @Autowired
...
//                System.out.println(jmPicUrl);
     ...
     * 聚美实拍
     * 1. 商品图（要上传）
     *   模板:http://s7d5.scene7.com/is/image/sneakerhead/bcbg_jumei_790x1241?$790_1241$&$images=%s
     * 2. PC端自定义图
     * 3. 购物流程图
     */
    private RuleExpression doDict_聚美实拍() {
        ...
        // 生成内容
        {
            // 商品图片
            {
                ...
                imageTemplate.addRuleWord(new TextWord("http://s7d5.scene7.com/is/image/sneakerhead/bcbg_jumei_790x1241?$790_1241$&$images=%s"));
