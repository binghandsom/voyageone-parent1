...
public class Jumei_027_Yoga_DictTest {
    @Autowired
...
//                System.out.println(jmPicUrl);
     ...
     * 聚美实拍
     * 1. 商品图（要上传）
     *   模板:http://s7d5.scene7.com/is/image/sneakerhead/790X790-img-JXJ?$790x790$&$img=%s
     * 2. PC端自定义图
     * 3. 购物流程图
     */
    private RuleExpression doDict_聚美实拍() {
        ...
        // 生成内容
        {
            // 商品图片
            {
                ...
                imageTemplate.addRuleWord(new TextWord("http://s7d5.scene7.com/is/image/sneakerhead/790X790-img-JXJ?$790x790$&$img=%s"));
