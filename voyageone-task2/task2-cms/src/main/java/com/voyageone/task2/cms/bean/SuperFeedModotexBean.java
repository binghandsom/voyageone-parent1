...
public class SuperFeedModotexBean extends SuperFeedBean {
    private String sku;
    ...
    public String getVoprice() {
        return voprice;
    }

    public void setVoprice(String voprice) {
        this.voprice = voprice == null ? null : voprice.trim();
    }
