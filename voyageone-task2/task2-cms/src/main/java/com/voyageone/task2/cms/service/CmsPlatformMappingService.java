...
//        field.setId(StringUtils.replaceDot(field.getId()));
    ...
    private MappingBean CreateImgMapping(String platformPropId, String imgTemplate) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            CustomWord productImageWord = new CustomWord(new CustomWordValueGetMainProductImages(null, imageTemplateExpression, imageIndexExpression, imageTypeExpression, null, null, null));
