...
public class SuperfeedBhfoBean {
    ...
    public String getMd5() {
        ...
        temp.append(this.getInventoryNumber());
        temp.append(this.getTitle());
        temp.append(this.getMsrp());
        temp.append(this.getVoyageonePrice());
        temp.append(this.getShippingCost());
        temp.append(this.getWeight());
        temp.append(this.getDescription());
        temp.append(this.getMainImageUrl());
        temp.append(this.getAdditionalImages());
        temp.append(this.getParentChildStandalone());
        temp.append(this.getItemGroupId());
        temp.append(this.getVariationSwapImageUrl());
        temp.append(this.getVaryingAttributeNames());
        temp.append(this.getVaryingAttribute1());
        temp.append(this.getVaryingAttribute2());
        temp.append(this.getBrand1());
        temp.append(this.getCountryOfOrigin());
        temp.append(this.getSeriesName());
        temp.append(this.getGtin());
        temp.append(this.getMpn());
        temp.append(this.getStoreCategory());
        temp.append(this.getMaterial());
        temp.append(this.getPattern());
        temp.append(this.getColor());
        temp.append(this.getSize());
        temp.append(this.getGender());
        temp.append(this.getAgeGroup());
        temp.append(this.getLength());
        temp.append(this.getWidth());
        temp.append(this.getHeight());
        temp.append(this.getAmazonBeautyItemType());
        temp.append(this.getAmazonDepartment());
        temp.append(this.getAmazonHeelHeight());
        temp.append(this.getAmazonHomeItemType());
        temp.append(this.getAmazonInseam());
        temp.append(this.getAmazonItemType());
        temp.append(this.getAmazonKeywords1());
        temp.append(this.getAmazonKeywords2());
        temp.append(this.getAmazonKeywords3());
        temp.append(this.getAmazonKeywords4());
        temp.append(this.getAmazonLegStyle());
        temp.append(this.getAmazonMensItemType());
        temp.append(this.getAmazonPhotoReady());
        temp.append(this.getAmazonProductType());
        temp.append(this.getAmazonRise());
        temp.append(this.getAmazonShoeItemType());
        temp.append(this.getAmazonShoeSize());
        temp.append(this.getAmazonShoeSizeMap());
        temp.append(this.getAmazonShoeWidth());
        temp.append(this.getAmazonSpecialSize());
        temp.append(this.getAmazonVariantDetails());
        temp.append(this.getAmazonWaistSize());
        temp.append(this.getAmazonWomensItemType());
        temp.append(this.getApparelStyle());
        temp.append(this.getApplication());
        temp.append(this.getApplicationArea());
        temp.append(this.getAmazonCategory());
        temp.append(this.getApplicationType());
        temp.append(this.getAsin());
        temp.append(this.getAssembly());
        temp.append(this.getAttachment());
        temp.append(this.getAuctionDescription());
        temp.append(this.getAudioOutputs());
        temp.append(this.getBackCoverage());
        temp.append(this.getBackPockets());
        temp.append(this.getBagDepthInches());
        temp.append(this.getBagHeightInches());
        temp.append(this.getBagLengthInches());
        temp.append(this.getBagWidthInches());
        temp.append(this.getBakeShape());
        temp.append(this.getBeddingSize());
        temp.append(this.getBhfoEbayCategory());
        temp.append(this.getBhfoEbayStoreCategory());
        temp.append(this.getBhfoAccessory1DescriptionC());
        temp.append(this.getBhfoAccessory1TitleC());
        temp.append(this.getBhfoColorC());
        temp.append(this.getBhfoColorTextC());
        temp.append(this.getBhfoCountryOfOriginC());
        temp.append(this.getBhfoFlawDescriptionC());
        temp.append(this.getBhfoSizeC());
        temp.append(this.getBhfoSizeAdditionalC());
        temp.append(this.getBhfoSizeTypeC());
        temp.append(this.getBhfoStyleC());
        temp.append(this.getBhfoStyleNameC());
        temp.append(this.getBhfoStyleTypeC());
        temp.append(this.getBottleMaterial());
        temp.append(this.getBottleSizeOunces());
        temp.append(this.getBottomClosure());
        temp.append(this.getBottomRise());
        temp.append(this.getBraClosure());
        temp.append(this.getBraFeatures());
        temp.append(this.getBraStraps());
        temp.append(this.getBrand2());
        temp.append(this.getCaStoreCategory());
        temp.append(this.getCandleSize());
        temp.append(this.getCapacityOunces());
        temp.append(this.getClassification());
        temp.append(this.getClosure());
        temp.append(this.getCollar());
        temp.append(this.getCollection());
        temp.append(this.getColor2());
        temp.append(this.getCompartment());
        temp.append(this.getCompatibleBrands());
        temp.append(this.getCompatibleProducts());
        temp.append(this.getCondition());
        temp.append(this.getConnectivity());
        temp.append(this.getCookingFunctions());
        temp.append(this.getCountryOfOrigin2());
        temp.append(this.getCupSize());
        temp.append(this.getDenimWash());
        temp.append(this.getDepthInches());
        temp.append(this.getDimensions());
        temp.append(this.getDimensions2());
        temp.append(this.getDirtCapture());
        temp.append(this.getDisplay());
        temp.append(this.getDressLength());
        temp.append(this.getDressType());
        temp.append(this.getDropLength());
        temp.append(this.getEan());
        temp.append(this.getEarpieceDesign());
        temp.append(this.getEbayHeelHeight());
        temp.append(this.getFabricType());
        temp.append(this.getFeatures());
        temp.append(this.getFeaturesAndFastening());
        temp.append(this.getFeatures2());
        temp.append(this.getFinish());
        temp.append(this.getFit());
        temp.append(this.getFitDesign());
        temp.append(this.getFlagstyle());
        temp.append(this.getFormulation());
        temp.append(this.getFrameMaterialType());
        temp.append(this.getFrameMetal());
        temp.append(this.getFrontStyle());
        temp.append(this.getFuelSource());
        temp.append(this.getFunction());
        temp.append(this.getFurType());
        temp.append(this.getGender2());
        temp.append(this.getGenre());
        temp.append(this.getHandleType());
        temp.append(this.getHarmonizedCode());
        temp.append(this.getHeelHeightInches());
        temp.append(this.getHeight2());
        temp.append(this.getImageUrl1());
        temp.append(this.getImageUrl2());
        temp.append(this.getImageUrl3());
        temp.append(this.getImageUrl4());
        temp.append(this.getIncludes());
        temp.append(this.getIncludes2());
        temp.append(this.getInseamInches());
        temp.append(this.getInsertMaterial());
        temp.append(this.getIsAChildItem());
        temp.append(this.getIsAParentItem());
        temp.append(this.getIsblocked());
        temp.append(this.getIsbn());
        temp.append(this.getIsfba());
        temp.append(this.getItemId());
        temp.append(this.getItemShape());
        temp.append(this.getItemSubtitle());
        temp.append(this.getItemTitle());
        temp.append(this.getItemauctiondescription());
        temp.append(this.getItemimageurl10());
        temp.append(this.getItemimageurl5());
        temp.append(this.getItemimageurl6());
        temp.append(this.getItemimageurl7());
        temp.append(this.getJacketLegth());
        temp.append(this.getJacketSleeveLengthInches());
        temp.append(this.getLength2());
        temp.append(this.getLensColor());
        temp.append(this.getLensMaterialType());
        temp.append(this.getLensWidthMillimeters());
        temp.append(this.getLid());
        temp.append(this.getLightbulbType());
        temp.append(this.getManufacturer());
        temp.append(this.getManufacturerDescription());
        temp.append(this.getMaterial2());
        temp.append(this.getMaterialSpecialty());
        temp.append(this.getMaxMagnification());
        temp.append(this.getMeliCategory());
        temp.append(this.getMeliColor());
        temp.append(this.getMeliSeason());
        temp.append(this.getMeliSize());
        temp.append(this.getMeliTitle());
        temp.append(this.getModelNumber());
        temp.append(this.getModelNumber2());
        temp.append(this.getMovement());
        temp.append(this.getMpn2());
        temp.append(this.getNeckSize());
        temp.append(this.getNeckline());
        temp.append(this.getItemlevelshipping());
        temp.append(this.getNonStick());
        temp.append(this.getNumberOfPieces());
        temp.append(this.getNumberOfSlices());
        temp.append(this.getOccasion());
        temp.append(this.getOpenQuantity());
        temp.append(this.getOpenquantitypooled());
        temp.append(this.getPadding());
        temp.append(this.getPantType());
        temp.append(this.getPantyStyle());
        temp.append(this.getParentSku());
        temp.append(this.getPattern2());
        temp.append(this.getPhotoSize());
        temp.append(this.getPillowSize());
        temp.append(this.getPlatform());
        temp.append(this.getPlatformHeightInches());
        temp.append(this.getPocketStyle());
        temp.append(this.getPolarizationType());
        temp.append(this.getPower());
        temp.append(this.getProductMargin());
        temp.append(this.getProtection());
        temp.append(this.getQuantityAvailable());
        temp.append(this.getRating());
        temp.append(this.getReceivedInInventory());
        temp.append(this.getRecommendedAge());
        temp.append(this.getRecommendedAgeRange());
        temp.append(this.getRelationshipName());
        temp.append(this.getRetailPrice());
        temp.append(this.getRiseInches());
        temp.append(this.getRugStyle());
        temp.append(this.getRykaConsignment());
        temp.append(this.getScentType());
        temp.append(this.getSeason());
        temp.append(this.getSellerLogoUrl());
        temp.append(this.getSet());
        temp.append(this.getShaftHeightInches());
        temp.append(this.getShaftWidthInches());
        temp.append(this.getShape());
        temp.append(this.getShoeClosure());
        temp.append(this.getShortDescription());
        temp.append(this.getSilhouette());
        temp.append(this.getSizeOrigin());
        temp.append(this.getSkirtLength());
        temp.append(this.getSkirtType());
        temp.append(this.getSku());
        temp.append(this.getSleeveLength());
        temp.append(this.getSleeveLengthInches());
        temp.append(this.getSpecialty());
        temp.append(this.getSport());
        temp.append(this.getStKeyword());
        temp.append(this.getStone());
        temp.append(this.getStoreTitle());
        temp.append(this.getStrapDropInches());
        temp.append(this.getStraps());
        temp.append(this.getStyle());
        temp.append(this.getSupplier());
        temp.append(this.getSupplierPo());
        temp.append(this.getSuppliercode());
        temp.append(this.getSupplierid());
        temp.append(this.getSwimwearBottom());
        temp.append(this.getSwimwearTop());
        temp.append(this.getTaxproductcode());
        temp.append(this.getTheme());
        temp.append(this.getThreadCount());
        temp.append(this.getTieLength());
        temp.append(this.getTieWidth());
        temp.append(this.getTotalDressLengthInches());
        ...
        temp.append(this.getVideoInputs());
        temp.append(this.getWaistAcrossInches());
        temp.append(this.getWalletHeightInches());
        temp.append(this.getWarehouselocation());
        temp.append(this.getWarranty());
        temp.append(this.getWeight2());
        temp.append(this.getWidth2());
        temp.append(this.getYear());
        temp.append(this.getRoom());
        temp.append(this.getLatestSupplier());
        temp.append(this.getBandSize());
        temp.append(this.getWalletWidthInches());
