 ...
 */
public class SuperFeedFragranceNetBean extends SuperFeedBean {
    ...
    public void setListingprice(String listingprice) {
        this.listingprice = listingprice == null ? null : listingprice.trim();
    }
    ...
    public void setShortdescriptions(String shortdescriptions) {
        this.shortdescriptions = shortdescriptions == null ? null : shortdescriptions.trim();
    }
    ...
    public void setItemgender(String itemgender) {
        this.itemgender = itemgender == null ? null : itemgender.trim();
    }
