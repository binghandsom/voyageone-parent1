 ...
 */
@Service
public class BhfoWsdlInsert extends BaseTaskService {
    ...
    @Autowired
    private BhfoFeedDao bhfoFeedDao;
        ...
        private List<CmsBtFeedInfoModel> getModels(String category) throws Exception {
            ...
            for (CmsBtFeedInfoBhfoModel vtmModelBean : vtmModelBeans) {
                ...
                for (FeedBean feedConfig : feedBeans) {
                    ...
                    String key = feedConfig.getCfg_val1().toLowerCase();
                    if(temp.get(key) == null) break;
