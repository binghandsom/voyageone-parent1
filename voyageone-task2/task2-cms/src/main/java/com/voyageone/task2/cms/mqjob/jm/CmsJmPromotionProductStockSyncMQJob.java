...
public class CmsJmPromotionProductStockSyncMQJob extends TBaseMQCmsService<JmPromotionProductStockSyncMQMessageBody> {
    ...
    private OperationResult syncStockByShop(ShopBean shopObj) {
        ...
        if (StringUtils.trimToNull(shopObj.getApp_url()) == null) {
            ...
            result.addErrorln("PromotionProductStockSyncService 店铺数据不完整！ channelId=%s, cartId=%s", channelId, cartIdStr);
            return result;
        }
        ...
        if (!exists) {
            ...
            result.addErrorln("PromotionProductStockSyncService 本店铺对应的cms_bt_product_cxxx表不存在！ channelId=" + channelId);
            return result;
        }
        ...
        if (cartBean == null) {
            ...
            result.addErrorln("PromotionProductStockSyncService 本店铺无平台数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
            return result;
        }
        ...
        if (CartEnums.Cart.JM.getId().equals(cartIdStr)) {
            ...
            if (jmProdList == null || jmProdList.isEmpty()) {
                ...
                result.addErrorln("JmPromotionProductStockSyncService 本店铺无活动下的产品数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
                return result;
            }
            // 过滤出商品code
            ...
            if (codeList == null || codeList.isEmpty()) {
                ...
                result.addErrorln("JmPromotionProductStockSyncService 本店铺无活动下的有效产品数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
                return result;
            }
            ...
            if (prodList == null || prodList.isEmpty()) {
                ...
                result.addErrorln("JmPromotionProductStockSyncService 无指定的产品数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
                return result;
            }
            ...
            for (CmsBtJmPromotionProductModel jmPromProd : jmProdList) {
                ...
                if (prodCode == null) {
                    ...
                    result.addErrorln("该数据有问题 CmsBtJmPromotionProductModel id=" + jmPromProd.getId());
                    continue;
                }
            ...
            if (promProdList == null || promProdList.isEmpty()) {
                ...
                result.addErrorln("PromotionProductStockSyncService 本店铺无活动下的产品数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
                return result;
            }
            ...
            if (codeList == null || codeList.isEmpty()) {
                ...
                result.addErrorln("PromotionProductStockSyncService 本店铺无活动下的有效产品数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
                return result;
            }
            ...
            if (prodList == null || prodList.isEmpty()) {
                ...
                result.addErrorln("PromotionProductStockSyncService 无指定的产品数据！ channelId=%s, cartId=%s", channelId, cartIdStr);
                return result;
            }
            ...
            for (CmsBtPromotionCodesModel promProd : promProdList) {
                ...
                if (prodCode == null) {
                    ...
                    result.addErrorln("该数据有问题 CmsBtPromotionCodesBean id=" + promProd.getId());
                    continue;
                }
                for (CmsBtProductModel prodObj : prodList) {
                    if (prodCode.equals(prodObj.getCommonNotNull().getFieldsNotNull().getCode())) {
