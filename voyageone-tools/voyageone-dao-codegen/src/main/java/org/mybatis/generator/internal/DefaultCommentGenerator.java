...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
        ...
        compilationUnit.addFileCommentLine(" * Copyright(C) 20xx-2015 VoyageOne Group Inc.");
        compilationUnit.addFileCommentLine(" * All rights reserved.");
        compilationUnit.addFileCommentLine(" * This class was generated by code generator, please don't modify it.");
        compilationUnit.addFileCommentLine(" * -----------------------------------------------");
        compilationUnit.addFileCommentLine(" */");
    }
