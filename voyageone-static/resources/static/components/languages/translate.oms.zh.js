            ...
            $translateProvider.translations (languageType.zh,
                {
                    ...
                    TXT_ORDERS_SEARCH_SEARCH_ORDER_KIND:'订单类型',
                    ...
                    TXT_ORDER_REFUND: '退款',
                    TXT_OMS_REFUND_LIST: '退款履历',
                    TXT_OMS_REFUND_INFO: '退款详情',
                    TXT_OMS_REFUND_STATUS: '退款状态',
                    TXT_OMS_REFUND_TYPE: '退款类型',
                    TXT_OMS_REFUND_AMOUNT: '退款金额',
                    TXT_OMS_REFUND_REASON: '退款原因',
                    TXT_OMS_REFUND_ID: '退款编号',
                    TXT_OMS_REFUND_TIME: '申请时间',
                    TXT_OMS_REFUND_COMMENT: '退款说明',
                    TXT_OMS_REFUND_AGREE: '同意退款',
                    TXT_OMS_REFUND_AGREE_SYNOMS: '同意退款同步OMS',
                    TXT_OMS_REFUND_REFUSE: '拒绝退款',
                    TXT_OMS_RETURN_GOODS_AGREE: '同意退货',
                    TXT_OMS_RETURN_GOODS_REFUSE: '拒绝退货',
                    TXT_OMS_RETURN_GOODS_REFILL: '回补物流信息',
                    TXT_OMS_REFUND_SHIP: '发货',
                    TXT_OMS_REFUSE_REASON: '拒绝理由',
                    TXT_OMS_AGREE_RETURN_GOODS_REASON: '同意退货理由',
                    TXT_OMS_REFUND_AGREE_IN_SERVER: '后台已完成退款',
                    TXT_OMS_REFUND_AGREE_IN_SERVER_PROMPT: '请确认后台已完成退款!',
                    TXT_OMS_REFUND_REFUSE_IN_SERVER: '后台已拒绝退款',
                    TXT_OMS_REFUND_REFUSE_IN_SERVER_PROMPT: '请确认后台已拒绝退款!',
                    TXT_OMS_REFUND_HISTORY: '退款履历',
                    TXT_OMS_SELLER: '卖家',
                    TXT_OMS_BUYER: '买家',
                    ...
                    TXT_ORDER_CUSTOMER_REFUSED: '客人拒收',
                    TXT_ORDER_INVOICE_STATUS: '发票状态',
                    TXT_ORDER_INVOICE_KIND: '发票类型',
                    TXT_ORDER_OTHER_INFO: '其他信息',
                    TXT_ORDER_CLIENT_ORDER_NUMBER: '第三方订单号',
                    TXT_ORDER_CANCEL_RM_ORDER: '顾客取消订单',
                    TXT_ORDER_CANCEL_RM_ORDER_EXPLAIN: '（向皇马推送取消订单申请）',
                    TXT_ORDER_SEND_RM_ORDER: '皇马订单推送',
                    TXT_ORDER_PARTNER_CANCEL_RM_ORDER: '皇马取消订单',
                    TXT_ORDER_PARTNER_CANCEL_RM_ORDER_EXPLAIN: '（皇马确认该订单取消）',
                    ...
                    TXT_ORDER_INDEX_TOTALPRICE: '总金额',
