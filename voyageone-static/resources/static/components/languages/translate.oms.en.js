            ...
            $translateProvider.translations(languageType.en,
                {
                    ...
                    TXT_ORDERS_SEARCH_SEARCH_ORDER_KIND:'Order Kind',
                    TXT_ORDERS_SEARCH_SEARCH_ORDER_KIND_Original:'Original',
                    TXT_ORDERS_SEARCH_SEARCH_ORDER_KIND_Split: 'Split',
                    ...
                    TXT_OMS_REFUND_LIST: 'Refund History',
                    TXT_OMS_REFUND_INFO: 'Refund Info',
                    TXT_OMS_REFUND_STATUS: 'Refund Status',
                    TXT_OMS_REFUND_TYPE: 'Refund Type',
                    TXT_OMS_REFUND_AMOUNT: 'Refund Amount',
                    TXT_OMS_REFUND_REASON: 'Refund Reason',
                    TXT_OMS_REFUND_ID: 'Refund ID',
                    TXT_OMS_REFUND_TIME: 'Refund Time',
                    TXT_OMS_REFUND_COMMENT: 'Refund Comment',
                    TXT_OMS_REFUND_AGREE: 'Refund Agree',
                    TXT_OMS_REFUND_AGREE_SYNOMS: 'Refund Agree Syn OMS',
                    TXT_OMS_REFUND_REFUSE: 'Refund Refuse',
                    TXT_OMS_RETURN_GOODS_AGREE: 'Return Goods Agree',
                    TXT_OMS_RETURN_GOODS_REFUSE: 'Return Goods Refuse',
                    TXT_OMS_RETURN_GOODS_REFILL: 'Return Goods Refill',
                    TXT_OMS_REFUND_SHIP: 'Ship',
                    TXT_OMS_REFUSE_REASON: 'Refuse Reason',
                    TXT_OMS_AGREE_RETURN_GOODS_REASON: 'Agree Return Goods Reason',
                    TXT_OMS_REFUND_AGREE_IN_SERVER: 'Refund Agree In Server',
                    TXT_OMS_REFUND_AGREE_IN_SERVER_PROMPT: 'Please confirm the background has completed a refund!',
                    TXT_OMS_REFUND_REFUSE_IN_SERVER: 'Refund Refuse In Server',
                    TXT_OMS_REFUND_REFUSE_IN_SERVER_PROMPT: 'Please confirm the background has refused a refund!',
                    TXT_OMS_REFUND_HISTORY: 'Refuse History',
                    ...
                    TXT_ORDER_CUSTOMER_REFUSED: 'Customer Refused',
                    TXT_ORDER_INVOICE_STATUS: 'Invoice Status',
                    TXT_ORDER_INVOICE_KIND: 'Invoice Kind',
                    TXT_ORDER_OTHER_INFO: 'Other Info',
                    TXT_ORDER_CLIENT_ORDER_NUMBER: 'Client Order#',
                    TXT_ORDER_CANCEL_RM_ORDER: 'Cancel RM Order',
                    TXT_ORDER_CANCEL_RM_ORDER_EXPLAIN: '（Post cancel order apply）',
                    TXT_ORDER_SEND_RM_ORDER: 'Send RM Order',
                    TXT_ORDER_PARTNER_CANCEL_RM_ORDER: 'Kitbag Cancel RM Order',
                    TXT_ORDER_PARTNER_CANCEL_RM_ORDER_EXPLAIN: '（RM confirm cancel order）',
                    ...
                    TXT_ORDER_INDEX_TOTALPRICE: 'Total Price',
