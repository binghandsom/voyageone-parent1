...
define(function(require) {
    ...
    defaultApp.service('customerIndexService', ['$q', 'omsAction', 'ajaxService',
        function($q, omsAction, ajaxService) {
            ...
            this.doInit = function (data, scope) {
                var defer = $q.defer();
                ajaxService.ajaxPost(data, omsAction.oms_customer_index_doInit, scope)
