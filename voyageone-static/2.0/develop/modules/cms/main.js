...
require.config({
    ...
    paths: {
        ...
        'angular-animate': 'libs/angular.js/1.4.8/angular-animate.min',
        'angular-route': 'libs/angular.js/1.4.8/angular-route.min',
        'angular-sanitize': 'libs/angular.js/1.4.8/angular-sanitize.min',
        'angular-cookies': 'libs/angular.js/1.4.8/angular-cookies.min',
        'angular': 'libs/angular.js/1.4.8/angular.min',
