...
require.config({
    ...
    paths: {
        ...
        'angular-animate': 'libs/angular.js/1.5.0-RC.0/angular-animate.min',
        'angular-route': 'libs/angular.js/1.5.0-RC.0/angular-route.min',
        'angular-sanitize': 'libs/angular.js/1.5.0-RC.0/angular-sanitize.min',
        'angular-cookies': 'libs/angular.js/1.5.0-RC.0/angular-cookies.min',
