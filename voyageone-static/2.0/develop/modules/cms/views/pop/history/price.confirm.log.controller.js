define([
    ...
    cms.controller('PriceConfirmLogController', (function () {
        function PriceConfirmLogController($menuService, context, priceConfirmLogService) {
            ...
            self.priceConfirmLogService = priceConfirmLogService;
        ...
        PriceConfirmLogController.prototype.getCartName = function (cartId) {
        ...
        PriceConfirmLogController.prototype.getData = function (pageNumber) {

            var self = this;
            var size = self.paging.size;

            self.priceConfirmLogService.page({
                skuCode: self.selected.sku.value,
                code: self.code,
                cartId: self.selected.cart.value,
