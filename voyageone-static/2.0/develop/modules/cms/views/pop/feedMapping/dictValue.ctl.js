...
define([
    ...
    return cms.controller('propFeedMappingDictValueController', (function () {

        function propFeedMappingDictValueController(context, feedMappingService, $uibModalInstance, alert) {
        ...
        propFeedMappingDictValueController.prototype = {
            init: function () {
        ...
        return propFeedMappingDictValueController;
    })());
});