...
<div class="panel panel-grey margin-bottom-5 rounded">
    ...
    <div class="panel-body" style="padding-top:5px;padding-bottom:1px;">
        <form class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <div class="col-sm-12">
                    <label class="control-label">Client Order No.:</label>
                </div>
                <div class="col-sm-12" style="padding-left: 5px;">
                    <input type="text" value="" id="search_client_order_number" class="form-control">
                </div>
            </div>
            <div class="form-group">
                <li class='list-group-item'><label class='checkbox inline' style='margin-top: 1px;margin-bottom: 1px;font-weight:500'><input type='checkbox' id='data_null_sub' />AMT IS NOT NULL</label></li>
            </div>
        </form>
    </div>
</div>
...
<!-- 检索条件载入 -->
<!-- 检索条件 -->
<script charset="UTF-8" type="text/javascript" src="<%=webRootPath%>/resource/js/module/financereportcost/search.js"></script>
